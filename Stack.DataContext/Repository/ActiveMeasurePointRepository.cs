...
{
    public class ActiveMeasurePointRepository : RepositoryBase<ActiveMeasurePoint>, IActiveMeasurePointRepository
    {

        public ActiveMeasurePointRepository(
            MeasureContext context,
            ILogger<ActiveMeasurePointRepository> logger) : base(context, logger)
        {
